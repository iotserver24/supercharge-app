...
const EN: TrayStrings = TrayStrings {
    ...
    account: "Account",
    new_chat: "New Chat",
    open_app: "Open Supercharge",
    quit: "Quit Supercharge",
    tooltip: "Supercharge",
    close: "Close",
...
const DE: TrayStrings = TrayStrings {
    ...
    account: "Konto",
    new_chat: "Neuer Chat",
    open_app: "Supercharge öffnen",
    quit: "Supercharge beenden",
    tooltip: "Supercharge",
    close: "Schließen",
...
const ES: TrayStrings = TrayStrings {
    ...
    account: "Cuenta",
    new_chat: "Nuevo chat",
    open_app: "Abrir Supercharge",
    quit: "Salir de Supercharge",
    tooltip: "Supercharge",
    close: "Cerrar",
...
const FIL: TrayStrings = TrayStrings {
    ...
    open_app: "Buksan ang Supercharge",
    quit: "Isara ang Supercharge",
    tooltip: "Supercharge",
    close: "Isara",
...
const FR: TrayStrings = TrayStrings {
    ...
    open_app: "Ouvrir Supercharge",
    quit: "Quitter Supercharge",
    tooltip: "Supercharge",
    close: "Fermer",
...
const ID: TrayStrings = TrayStrings {
    ...
    open_app: "Buka Supercharge",
    quit: "Keluar dari Supercharge",
    tooltip: "Supercharge",
    close: "Tutup",
...
const IT: TrayStrings = TrayStrings {
    ...
    account: "Account",
    new_chat: "Nuova chat",
    open_app: "Apri Supercharge",
    quit: "Esci da Supercharge",
    tooltip: "Supercharge",
    close: "Chiudi",
...
const JA: TrayStrings = TrayStrings {
    ...
    account: "アカウント",
    new_chat: "新しいチャット",
    open_app: "Supercharge を開く",
    quit: "Supercharge を終了",
    tooltip: "Supercharge",
    close: "閉じる",
...
const PT_BR: TrayStrings = TrayStrings {
    ...
    open_app: "Abrir o Supercharge",
    quit: "Sair do Supercharge",
    tooltip: "Supercharge",
    close: "Fechar",
    usage_with_reset: "Uso  ·  {pct}% restante  ·  {time}",
    usage_pct: "Uso  ·  {pct}% restante",
...
const RU: TrayStrings = TrayStrings {
    ...
    account: "Аккаунт",
    new_chat: "Новый чат",
    open_app: "Открыть Supercharge",
    quit: "Выйти из Supercharge",
    tooltip: "Supercharge",
    close: "Закрыть",
...
const TA: TrayStrings = TrayStrings {
    ...
    open_app: "Supercharge ஐத் திற",
    quit: "Supercharge இலிருந்து வெளியேறு",
    tooltip: "Supercharge",
    close: "மூடு",
...
const UK: TrayStrings = TrayStrings {
    ...
    new_chat: "Новий чат",
    open_app: "Відкрити Supercharge",
    quit: "Вийти з Supercharge",
    tooltip: "Supercharge",
    close: "Закрити",
