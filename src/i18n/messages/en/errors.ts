...
export const enErrors = {
  ...
  "error.deck.cli.problem": "Supercharge CLI not found",
  ...
  "error.deck.cliTooOld.problem": "Supercharge CLI is too old",
  "error.deck.cliTooOld.cause": "The installed Supercharge CLI rejects flags this app depends on. Upgrade the CLI, then restart sessions.",
