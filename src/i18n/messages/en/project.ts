...
export const enProject = {
  ...
  "project.continueCwdNone": "No agent session found for this project (same as CLI supercharge -c/--continue).",
  ...
  "project.continueCwdNoCli": "Supercharge CLI not found — install or set the CLI path, then try Continue again.",
