...
export const enChat = {
  ...
  "chat.activity.explore": "Inspecting files and sources",
  "chat.activity.commands": "Commands",
  "chat.activity.changes": "File changes",
  "chat.activity.agents": "Agents",
  "chat.activity.other": "Other tools",
  "chat.activity.preparing": "Preparing next action…",
  "chat.activity.attention": "Needs attention",
  "chat.activity.actions": "{n} actions",
  "chat.activity.hide": "Hide activity",
  "chat.activity.show": "View activity",
  "chat.activity.raw": "Full event log",
