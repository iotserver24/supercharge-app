...
export const enCore = {
  ...
  "cliUpdate.notice": "Supercharge CLI {current} → {latest} available",
  ...
  "app.quitBusy.automationsNote": "Enabled scheduled tasks will pause after quit until you reopen Supercharge. There is no separate background daemon.",
  "app.quitBusy.automationsNoteLogin": "Enabled scheduled tasks pause after quit; Launch at login will restart Supercharge after your next sign-in (not immediately).",
  "app.quitPressAgain": "Press again to quit",
  "common.cancel": "Cancel",
  "common.confirm": "Confirm",
  "common.save": "Save",
  "common.dismiss": "Dismiss",
  "onboarding.welcome": "Welcome to Supercharge",
  ...
  "onboarding.importGo": "Import from supercharge-go",
  "onboarding.importGoHint": "Read-only import from known config paths",
  "onboarding.importCli": "Import CLI ~/.supercharge",
  ...
  "notify.turnDoneTitle": "Supercharge finished a turn",
  ...
  "endOfTurn.cliUpgrade": "Stopped — Supercharge CLI was updated",
  ...
  "tray.openApp": "Open Supercharge",
  "tray.quit": "Quit Supercharge",
  ...
  "skillsPicker.hostOnlyHint": "Skills need the desktop host and Supercharge CLI. Check Settings → CLI / Runtime.",
