...
export const zhTWCore = {
  ...
  "cliUpdate.notice": "Supercharge CLI {current} → {latest} 可更新",
  ...
  "app.quitBusy.automationsNote": "已開啟的已排程任務會在結束後暫停，直到你再次開啟 Supercharge。沒有獨立的背景守護行程。",
  "app.quitBusy.automationsNoteLogin": "已開啟的已排程任務會在結束後暫停；「登入時啟動」會在你下次登入後重新開啟 Supercharge（不會立刻重啟）。",
  "app.quitPressAgain": "再按一次結束",
  "common.cancel": "取消",
  "common.confirm": "確認",
  "common.save": "儲存",
  "common.dismiss": "關閉",
  "onboarding.welcome": "歡迎使用 Supercharge",
  "onboarding.body": "MIT · 非 provider 官方。選擇一種帳戶方式，或跳過先進入介面。",
  ...
  "onboarding.importGo": "從 supercharge-go 匯入",
  "onboarding.importGoHint": "唯讀匯入已知設定路徑",
  "onboarding.importCli": "匯入 CLI ~/.supercharge",
  ...
  "notify.turnDoneTitle": "Supercharge 已完成一輪",
  ...
  "endOfTurn.cliUpgrade": "已停止 — Supercharge CLI 已升級",
  ...
  "tray.account": "帳戶",
  "tray.newChat": "新對話",
  "tray.openApp": "開啟 Supercharge",
  "tray.quit": "結束 Supercharge",
  ...
  "skillsPicker.hostOnlyHint": "技能需要桌面宿主與 Supercharge CLI。請檢查「設定 → CLI / 執行階段」。",
