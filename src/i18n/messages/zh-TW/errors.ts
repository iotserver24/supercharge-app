...
export const zhTWErrors = {
  ...
  "error.deck.cli.problem": "找不到 Supercharge CLI",
  ...
  "error.deck.cliTooOld.problem": "Supercharge CLI 版本過舊",
  "error.deck.cliTooOld.cause": "目前的 Supercharge CLI 不認得應用相依的參數。請升級 CLI 後重新啟動對話。",
