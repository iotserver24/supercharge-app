...
export const zhTWChat = {
  ...
  "chat.activity.explore": "檢查檔案與來源",
  "chat.activity.commands": "命令",
  "chat.activity.changes": "檔案修改",
  "chat.activity.agents": "代理",
  "chat.activity.other": "其他工具",
  "chat.activity.preparing": "準備下一步…",
  "chat.activity.attention": "需要關注",
  "chat.activity.actions": "{n} 項操作",
  "chat.activity.hide": "收起活動",
  "chat.activity.show": "查看活動",
  "chat.activity.raw": "完整事件記錄",
  "chat.thinking": "思考中…",
