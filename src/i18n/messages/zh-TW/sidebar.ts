...
export const zhTWSidebar = {
  ...
  "sidebar.importCliSessions": "從 Supercharge CLI 匯入",
  "sidebar.importCliSessionsHint": "Supercharge CLI 對話仍在 ~/.supercharge，匯入後才會出現在側欄。",
  ...
  "sidebar.remoteDeleteConfirm": "確定永久刪除 {alias} 上的「{name}」？遠端 Supercharge 會話會被刪掉。",
