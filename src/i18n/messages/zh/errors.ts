...
export const zhErrors = {
  ...
  "error.deck.cli.problem": "未找到 Supercharge CLI",
  ...
  "error.deck.cliTooOld.problem": "Supercharge CLI 版本过低",
  "error.deck.cliTooOld.cause": "当前 Supercharge CLI 不认识应用依赖的参数。请升级 CLI 后重启会话。",
