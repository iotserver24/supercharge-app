...
export const zhSidebar = {
  ...
  "sidebar.importCliSessions": "从 Supercharge CLI 导入",
  "sidebar.importCliSessionsHint": "Supercharge CLI 对话仍在 ~/.supercharge，导入后才会出现在侧栏。",
  ...
  "sidebar.remoteDeleteConfirm": "确定永久删除 {alias} 上的「{name}」？远程 Supercharge 会话会被删掉。",
