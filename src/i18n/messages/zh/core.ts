...
export const zhCore = {
  ...
  "app.quitBusy.automationsNote": "已开启的已安排任务会在退出后暂停，直到你再次打开 Supercharge。没有独立的后台守护进程。",
  "app.quitBusy.automationsNoteLogin": "已开启的已安排任务会在退出后暂停；「登录时启动」会在你下次登录后重新打开 Supercharge（不会立刻重启）。",
  "app.quitPressAgain": "再按一次退出",
  "common.cancel": "取消",
  "common.confirm": "确认",
  "common.save": "保存",
  "common.dismiss": "关闭",
  "onboarding.welcome": "欢迎使用 Supercharge",
  "onboarding.body": "MIT · 非 provider 官方。选择一种账户方式，或跳过先进壳。",
  ...
  "onboarding.importGo": "从 supercharge-go 导入",
  "onboarding.importGoHint": "只读导入已知配置路径",
  "onboarding.importCli": "导入 CLI ~/.supercharge",
  ...
  "notify.turnDoneTitle": "Supercharge 已完成一轮",
  ...
  "endOfTurn.cliUpgrade": "已停止 — Supercharge CLI 已升级",
  ...
  "tray.account": "账户",
  "tray.newChat": "新对话",
  "tray.openApp": "打开 Supercharge",
  "tray.quit": "退出 Supercharge",
  ...
  "skillsPicker.hostOnlyHint": "技能需要桌面宿主与 Supercharge CLI。请检查「设置 → CLI / 运行时」。",
