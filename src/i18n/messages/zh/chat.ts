...
export const zhChat = {
  ...
  "chat.activity.explore": "检查文件与来源",
  "chat.activity.commands": "命令",
  "chat.activity.changes": "文件修改",
  "chat.activity.agents": "智能体",
  "chat.activity.other": "其他工具",
  "chat.activity.preparing": "准备下一步…",
  "chat.activity.attention": "需要关注",
  "chat.activity.actions": "{n} 项操作",
  "chat.activity.hide": "收起活动",
  "chat.activity.show": "查看活动",
  "chat.activity.raw": "完整事件日志",
  "chat.thinking": "思考中…",
