...
> = {
  ...
  cli_too_old:
    "Update Supercharge CLI (`supercharge update`) and fully restart the app to enable validate.",
  cli_missing: "Install or path the Supercharge CLI, then retry validate.",
