 ...
 * Live work uses a compact latest-action preview instead of forcing the rail open.
 * Both live and finished phases follow the user's auto-collapse preference.
