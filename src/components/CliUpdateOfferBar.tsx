...
export function CliUpdateOfferBar({
  ...
  return (
    <div className="cli-update-notice" role="status">
      <span className="cli-update-notice__label">
        {t("cliUpdate.notice", {
      ...
      <button
        type="button"
        className="btn btn--ghost cli-update-notice__action"
        disabled={busy}
        onClick={() => {
          if (offer.appBehind) {
            appBehindDialog(() => doInstall(true));
