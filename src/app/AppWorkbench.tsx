...
export function AppWorkbench() {
  ...
  const providerActiveSourceRef = useRef("official");
  ...
  providerActiveSourceRef.current = providerActiveSource;
      ...
      const failPending = (errText?: string) => {
        ...
        patchSessionMessages(errTarget, (m) =>
          applyTurnError(
            ...
            {
              activeSource:
                providerActiveSourceRef.current === "custom"
                  ? "custom"
                  : providerActiveSourceRef.current === "official"
                    ? "official"
                    : null,
            },
          ),
